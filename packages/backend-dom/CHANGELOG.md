...
- 176e8a1: backend-dom S4: accessibility + CSS-variable theming
...
- 296272f: 0.21: backend-dom — tune DOM text baseline (0.8em → 0.84em)
...
- 23569e6: 0.21: backend-dom Stage S3 — the retained-DOM reconciler
...
- 7bd08b9: 0.21: backend-dom — fix DOM text positioning (alignment + baseline)
