...
const diagInBase = Object.keys(sceneIndex.metafile.inputs).filter((i) =>
  /scene\/(src|dist)\/(displayDiff|cacheColdAudit|diagnostics|fontUsage)\./.test(i),
);
